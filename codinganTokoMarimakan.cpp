...
int main(){
	...
	char lagi;
	char cukup;
	int hargaakhir , totalharga , uang , kembalian , jarak, ongkir;
	float lol= 0;


choose:	
	cout<<"_________________________________"<< endl;
	cout<<"Selamat datang di Toko MauMakan"<< endl;
...
ongkir:
	...
	cout<<"biaya ongkir adalah "<< ongkir<<endl;
	
pembayaran:
	totalharga= h_soto+h_sate+h_ayambakar+h_esteh+h_jusmangga+h_kopi+ongkir;
	cout<<"Total harga "<< totalharga<<endl;
	
	if (totalharga>= 30000){
		hargaakhir = totalharga*0.90;
	}
cout<<"harga setelah didiskon "<< hargaakhir<<endl;
cout<<"harga akhir adalah "<< hargaakhir;
	return 0;
